...
func main() {
	...
	// setup the gin engine and the swagger endpoint
	r := gin.Default()
	...
	r.Use(cors.New(cors.Config{
		...
		AllowHeaders:     []string{"Origin", "Accept", "Content-Type", "Content-Length", "Accept-Encoding", "X-CSRF-Token", "Authorization", "Cache-Control", "X-Requested-With"},
